                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php foreach($facultades as $facultad): ?>
                                    <tr class="text-center" data-id="<?php echo e($facultad->id); ?>">
                                        ...
                                        <td class="center"><a href="<?php echo e(route('facultad.edit',$facultad->id)); ?>"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        <?php echo Form::open(['route' => ['facultad.destroy', ':FACULTAD_ID'], 'method' => 'DELETE', 'id' => 'form-delete']); ?>
