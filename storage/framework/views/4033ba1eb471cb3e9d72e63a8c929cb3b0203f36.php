                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <?php echo Form::open(['route' => 'escuela.create', 'method' => 'GET']); ?>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php foreach($escuelas as $escuela): ?>
                                    <tr class="text-center" data-id="<?php echo e($escuela->id); ?>">
                                        <td class="center"><?php echo e($escuela->id); ?></td>
                                        <td class="center"><?php echo e($escuela->nombre); ?></td>
                                        <td class="center"><?php echo e($escuela->descripcion); ?></td>
                                        <td class="center"><?php echo e($escuela->departamento); ?></td>
                                        <td class="center"><a href="<?php echo e(route('escuela.edit',$escuela->id)); ?>"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        <?php echo Form::open(['route' => ['escuela.destroy', ':ESCUELA_ID'], 'method' => 'DELETE', 'id' => 'form-delete']); ?>
