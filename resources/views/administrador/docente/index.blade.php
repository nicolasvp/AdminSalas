                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach($docentes as $docente)
                        <tr class="text-center" data-id="{{ $docente->id }}">
                            ...
                            <td class="center"><a href="{{ route('administrador.docente.edit',$docente->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                            {!! Form::open(['route' => ['administrador.docente.destroy', ':DOCENTE_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                            {!! Form::close() !!}
                            </td>                                         
                        </tr>
                    @endforeach
