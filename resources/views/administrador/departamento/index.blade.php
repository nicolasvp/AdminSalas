        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        {!! Form::open(['route' => 'administrador.departamento.create', 'method' => 'GET']) !!}
                            <button type="submit" class="btn btn-success" style="float: right; margin-top: 10px;">Ingresar  <i class="fa fa-plus"></i></button>
                        {!! Form::close() !!}

                        {!! Form::open(['route' => 'administrador.departamento.download', 'method' => 'GET']) !!}
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach($departamentos as $departamento)
                        <tr class="text-center" data-id="{{ $departamento->id }}">
                            <td class="center">{{ $departamento->id }}</td>
                            <td class="center">{{ $departamento->nombre }}</td>
                            <td class="center">{{ $departamento->descripcion }}</td>
                            <td class="center">{{ $departamento->facultad }}</td>
                            <td class="center"><a href="{{ route('administrador.departamento.edit',$departamento->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                            {!! Form::open(['route' => ['administrador.departamento.destroy', ':DEPARTAMENTO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                            {!! Form::close() !!}
                            </td>                                         
                        </tr>
                    @endforeach
