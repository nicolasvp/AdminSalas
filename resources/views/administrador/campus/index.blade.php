                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach($campus as $c)
                        <tr class="text-center" data-id="{{ $c->id }}">
                            ...
                            <td class="center"><a href="{{ route('administrador.campus.edit',$c->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                            {!! Form::open(['route' => ['administrador.campus.destroy', ':CAMPUS_ID'], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
                            {!! Form::close() !!}
                            </td>                                        
                        </tr>
                    @endforeach
