                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::open(['route' => 'administrador.asignatura.create', 'method' => 'GET']) !!}
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                @foreach($asignaturas as $asignatura)
                                    <tr class="text-center" data-id="{{ $asignatura->id }}">
                                        ...
                                        <td class="center"><a href="{{ route('administrador.asignatura.edit',$asignatura->id)}}"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        {!! Form::open(['route' => ['administrador.asignatura.destroy', ':ASIGNATURA_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                                        {!! Form::close() !!}
                                        </td>                                         
                                    </tr>
                                @endforeach
