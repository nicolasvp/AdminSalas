        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        {!! Form::open(['route' => 'administrador.escuela.create', 'method' => 'GET']) !!}
                            <button type="submit" class="btn btn-success" style="float: right; margin-top: 10px;">Ingresar  <i class="fa fa-plus"></i></button>
                        {!! Form::close() !!}

                        {!! Form::open(['route' => 'administrador.escuela.download', 'method' => 'GET']) !!}
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach($escuelas as $escuela)
                        <tr class="text-center" data-id="{{ $escuela->id }}">
                            <td class="center">{{ $escuela->id }}</td>
                            <td class="center">{{ $escuela->nombre }}</td>
                            <td class="center">{{ $escuela->descripcion }}</td>
                            <td class="center">{{ $escuela->departamento }}</td>
                            <td class="center"><a href="{{ route('administrador.escuela.edit',$escuela->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                            {!! Form::open(['route' => ['administrador.escuela.destroy', ':ESCUELA_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                            {!! Form::close() !!}
                            </td>                                         
                        </tr>
                    @endforeach
