...
@section('option')
    <li class="active">Tipos de Salas</li>
@stop
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        {!! Form::open(['route' => 'administrador.tipo_sala.create', 'method' => 'GET']) !!}
                            <button type="submit" class="btn btn-success" style="float: right; margin-top: 10px;">Ingresar  <i class="fa fa-plus"></i></button>
                        {!! Form::close() !!}

                        {!! Form::open(['route' => 'administrador.tipo_sala.download', 'method' => 'GET']) !!}
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    @foreach($tipos as $tipo)
                        <tr class="text-center" data-id="{{ $tipo->id }}">
                            <td class="center">{{ $tipo->id }}</td>
                            <td class="center">{{ $tipo->nombre }}</td>
                            <td class="center">{{ $tipo->descripcion }}</td>
                            <td class="center"><a href="{{ route('administrador.tipo_sala.edit',$tipo->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                            {!! Form::open(['route' => ['administrador.tipo_sala.destroy', ':TIPO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                            {!! Form::close() !!}
                            </td>                                         
                        </tr>
                    @endforeach
