...
@section('option')
    <li><a href="{{ route('encargado.horario.index') }}">Horarios</a></li>
                      ...
                      <div class="col-lg-6">
                          {!! Form::model($horario, ['route' => ['encargado.horario.update', $horario], 'method' => 'PUT']) !!}
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
                              ...
                              <div class="form-group">
                                  <input type="text" class="form-control" name="comentario" id="comentario" placeholder="Ej: Sala no disponible...">
                              </div> 
