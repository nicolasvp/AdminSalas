                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::open(['route' => 'periodo.create', 'method' => 'GET']) !!}
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                @foreach($periodos as $periodo)
                                    <tr class="text-center" data-id="{{ $periodo->id }}">
                                        ...
                                        <td class="center"><a href="{{ route('periodo.edit',$periodo->id)}}"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        {!! Form::open(['route' => ['periodo.destroy', ':PERIODO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                                        {!! Form::close() !!}
                                        </td>                                         
                                    </tr>
                                @endforeach
...
$(document).ready(function() {
    ...
    $('.btn-delete').click(function(e){
        ...
        var url = form.attr('action').replace(':PERIODO_ID', id);
