                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::open(['route' => 'curso.create', 'method' => 'GET']) !!}
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                @foreach($cursos as $curso)
                                    <tr class="text-center" data-id="{{ $curso->id }}">
                                        ...
                                        <td class="center"><a href="{{ route('curso.edit',$curso->id)}}"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        {!! Form::open(['route' => ['curso.destroy', ':CURSO_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                                        {!! Form::close() !!}
                                        </td>                                         
                                    </tr>
                                @endforeach
