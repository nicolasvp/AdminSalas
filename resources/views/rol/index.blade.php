                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    {!! Form::open(['route' => 'rol.create', 'method' => 'GET']) !!}
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                @foreach($roles as $rol)
                                    <tr class="text-center" data-id="{{ $rol->id }}">
                                        <td class="center">{{ $rol->id }}</td>
                                        <td class="center">{{ $rol->nombre }}</td>
                                        <td class="center">{{ $rol->descripcion }}</td>
                                        <td class="center"><a href="{{ route('rol.edit',$rol->id)}}"><i class="fa fa-edit"></i></a></td>
                                        <td class="center"><a href="#!" class="btn-delete"><i class="fa fa-trash"></i></a>
                                        {!! Form::open(['route' => ['rol.destroy', ':ROL_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
                                        {!! Form::close() !!}
                                        </td>                                         
                                    </tr>
                                @endforeach
